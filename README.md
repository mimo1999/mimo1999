...
- 🛠️ 3+ years shipping ML in production: HighRadius (fintech, Associate Software Engineer) and
  Siemens Healthineers (Working Student)
- 📄 Co-inventor on two US patents (one granted, one pending) for ML-based financial forecasting
- 🌍 Cross-domain: fintech forecasting, clinical/healthcare AI, and agentic systems research
